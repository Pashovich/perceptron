...
${OBJECTDIR}/file/fileOperator.o: file/fileOperator.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file/fileOperator.o file/fileOperator.cpp

${OBJECTDIR}/incdecOperator/valueChanger.o: incdecOperator/valueChanger.cpp
	${MKDIR} -p ${OBJECTDIR}/incdecOperator
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/incdecOperator/valueChanger.o incdecOperator/valueChanger.cpp

${OBJECTDIR}/learnIt/learnAI.o: learnIt/learnAI.cpp
	${MKDIR} -p ${OBJECTDIR}/learnIt
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/learnIt/learnAI.o learnIt/learnAI.cpp
...
${OBJECTDIR}/parceptron/parceptron.o: parceptron/parceptron.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parceptron/parceptron.o parceptron/parceptron.cpp

${OBJECTDIR}/randomizer/randomizer.o: randomizer/randomizer.cpp
	${MKDIR} -p ${OBJECTDIR}/randomizer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/randomizer/randomizer.o randomizer/randomizer.cpp
